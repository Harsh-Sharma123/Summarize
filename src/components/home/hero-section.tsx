...
export default function HeroSection() {
  return (
    <>
      <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-15 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
        <div className="">
          <div className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800 animate-gradient-x group hover:cursor-pointer">
            <Badge
              variant={"secondary"}
        ...
        <h2 className="text-lg sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-2xl text-gray-600">
