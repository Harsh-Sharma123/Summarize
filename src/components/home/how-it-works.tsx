...
export default function HowItWorks() {
  const steps: Step[] = [
    ...
    },
    {
      ...
      label: "AI Analysis",
      description:
        "Our advanced AI processes analyzes your documents instantly",
    },
    {
    ...
    <section className="relative overflow-hidden bg-gray-50">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        <div className="text-center mb-16">
          <h2 className="font-bold uppercase text-xl text-rose-500 mb-4">
            How it works
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relativ">
          {steps.map((step, ind) => (
            <div className="relative flex items-stretch">
              <StepItem key={ind} {...step} />
              {ind < steps.length - 1 && (
...
function StepItem({ icon, label, description }: Step) {
  return (
    <div className="relative p-2 rounded-2xl bg-white/5 backdrop-blue-xs border border-white/10 hover:border-rose-500/50 transition-colors group w-full">
